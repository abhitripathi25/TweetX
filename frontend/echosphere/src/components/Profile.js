  ...
  return (
    ...
    <div>
        <div className='flex items-center py-2'>
            ...
            <div className='ml-2'>
                <h1 className='font-bold text-lg'>{profile?.name}</h1> {/* Placeholder name */}
                <p className='text-gray-500 text-sm'>10 posts</p> {/* Placeholder post count */}
            </div>
        </div>
        ...
        <div className='m-4'>
            <h1 className='font-bold text-xl'>{profile?.name}</h1> {/* Placeholder name */}
            <p>`@${profile?.username}`</p> {/* Placeholder username */}
        </div>
